...
// 2. Chuan bi cau truy van & 3. Thuc thi cau truy van
    ...
    $sql = "
        ...
        Where sua.Ten_sua  LIKE '%$tensua%' AND hang_sua.Ma_hang_sua  LIKE '%$hangsua%'
        ...
        <form action="" method="POST">
            ...
            <p>
                ...
                <select name="loaisua">    
                    ...
                    ?>
                        <option value="<?php echo $rows2[0]; ?>" 
                        <?php if(isset($_POST['loaisua']) && $_POST['loaisua'] == $rows2[0]) 
                        echo "selected" ?>>                        
                        <?php echo $rows2[1]; ?>
                    </option>
                        <?php endwhile; ?>
                        <option value="" <?php if(isset($_POST['loaisua']) && $_POST['loaisua'] == "") echo "selected"  ?>>---</option>
                    </select>
                ...
                <select name="hangsua">    
                    ...
                    ?>
                        <option value="<?php echo $rows2[0]; ?>" 
                        <?php if(isset($_POST['hangsua']) && $_POST['hangsua'] == $rows2[0]) 
                        echo "selected" ?>>                        
                        <?php echo $rows2[1]; ?>
                    </option>
                        <?php endwhile; ?>
                        <option value="" <?php if(isset($_POST['hangsua']) && $_POST['hangsua'] == "") echo "selected"  ?>>---</option>
                    </select>
            </p>
