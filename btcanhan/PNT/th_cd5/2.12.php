...
echo "<p align='center'><font size='5' color='blue'> THÔNG TIN KHÁCH HÀNG</font></P>";
 ...
 echo '<tr >
    ...
    <th width="150"><img src = "./icon_sua.png" width = 20 height=20 /></th>
    <th width="150"><img src = "./icon_xoa.png"  width = 20 height=20/></th>
 ...
 {	 $stt=$offset + 1;
	...
	{      
        ...
        echo "<tr>";
             ...
             echo "<td>$rows[5]</td>";
             echo "<td><a href = 'xuli2.12.php?work=edit&id=$rows[0]'>Sửa</a></td>";
             echo "<td><a href = 'xuli2.12.php?work=delete&id=$rows[0]'>Xoá</a></td>";
