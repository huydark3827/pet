...
// 2. Chuan bi cau truy van & 3. Thuc thi cau truy van
    ...
    $sql = "
        SELECT sua.Hinh, sua.Ten_sua, sua.Trong_luong, sua.Don_gia, sua.Ma_sua
        FROM (
    ...
    $result = mysqli_query($conn, 'SELECT sua.Hinh, sua.Ten_sua, sua.Trong_luong, sua.Don_gia, sua.Ma_sua
    FROM (
        sua INNER JOIN loai_sua ON sua.Ma_loai_sua = loai_sua.Ma_loai_sua)
...
// 4.Xu ly du lieu tra ve
 ...
 {	$stt=$offset+ 1;
	...
	{         
        echo ($n%5==0) ? "<tr>" : "";
        echo '<td>';
        echo "<p><a href = 'b2.7_chitiet.php?id=$rows[4]'> $rows[1] </a> </p>";
