...
// 2. Chuan bi cau truy van & 3. Thuc thi cau truy van
    ...
    $sql = "
        SELECT sua.Hinh, sua.Ten_sua, hang_sua.Ten_hang_sua, loai_sua.Ten_loai , sua.Trong_luong, sua.Don_gia
        FROM (
    ...
    $result = mysqli_query($conn, 'SELECT sua.Hinh, sua.Ten_sua, hang_sua.Ten_hang_sua, loai_sua.Ten_loai , sua.Trong_luong, sua.Don_gia
    FROM (
        sua INNER JOIN loai_sua ON sua.Ma_loai_sua = loai_sua.Ma_loai_sua)
...
// 4.Xu ly du lieu tra ve
 ...
 echo '
 <tr >
    <td colspan=2 ><center><font size="5" color="blue"> THÔNG TIN SỮA</font></center></td>
 </tr>';
